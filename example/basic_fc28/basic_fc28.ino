...
FC28Sensor fc28; // create a new object with the name fc28 to hold the FC28Sensor class

#define SensorFC28_Pin 15 // fc-28 pin declaration
...
void setup() {
  ...
  fc28.begin(SensorFC28_Pin); // initiate fc-28 sensor
}
